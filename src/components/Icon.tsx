...
export type IconName = 'moon' | 'sun' | 'calendar' | 'grid' | 'settings' | 'plus' | 'chevron' | 'left' | 'right' | 'check' | 'close' | 'mini' | 'expand' | 'minus' | 'bell' | 'clock' | 'repeat' | 'edit' | 'trash' | 'pin' | 'arrowUp' | 'arrowDown' | 'list' | 'checkCircle';
