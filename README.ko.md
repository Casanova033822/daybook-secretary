...
1. **일정 추가:** 이름을 입력하거나 명상, 운동, 아침 식사 같은 프리셋을 선택하세요.
2. **시간 설정:** 시작·종료 시간을 정하고 필요하면 알림이나 반복을 추가한 뒤 저장하세요. 시간이 미정이라면 「할 일로 기록」을 선택할 수 있습니다.
3. **확인과 완료:** 일·주·월 보기로 일정을 확인하세요. 끝낸 일은 왼쪽 상자를 체크하고, 수정하려면 연필을 누르세요.
4. **내게 맞게 설정:** 환경설정에서 프리셋, 언어, 기본 알림을 바꿀 수 있습니다. 라이트·다크 모드는 「일정 추가」 위에서 전환하세요.
